...
<div class="header">
    ...
    <nav>
        ...
        <div class="nav_menu"><a href="academy_option_add.php">학원별관리</a></div>
    ...
    <div class="header_right">
        ...
        <div class="logout_btn"><a href="../logout.php?url=/bbs/admin/login.php">로그아웃</a></div>
        <div class="pass_change_btn"><a href="home_pass_change.php">비밀번호 변경</a></div>
    </div>
</div>
<!-- } 상단 끝 -->
