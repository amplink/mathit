...
//동일 레벨
$sql = "select score1, score2, score3 from `teacher_score` where `test_genre` = '$test_genre' and `class`='$class';";
$result = mysqli_query($connect_db, $sql);
$a_score_list1 = array();
$a_tot1 = 0;
$a_cnt1 = 0;
...
<table border="1">
    ...
    <tr>
        ...
        <td colspan="3" align="center">  <?=sprintf("%.1f", ($tot/$cnt/3))?> 점 <br> <?=sprintf("%.1f", max($score_list)/$cnt/3)?> 점</td>
    ...
    <tr>
        ...
        <td colspan="3" align="center">  <?=sprintf("%.1f", $a_tot1/$a_cnt1/3)?> 점 <br> <?=sprintf("%.1f", $a_tot/$a_cnt2/3)?> 점</td>
...
<table border="1">
    <tr>
        ...
        <td colspan="4" width="1000" align="center" bgcolor="#006400" style="color:#fff"> 3회 </td>
        <td colspan="3" width="1500" align="center" bgcolor="#006400" style="color:#fff"> 총점 </td>
    </tr>
    <?php
    ...
    while($res = mysqli_fetch_array($result)) {
        ...
        <tr>
            ...
            <td colspan="3" align="center"> <?=$res['score1']+$res['score2']+$res['score3']?> 점 </td>
        </tr>
        <?
        $i++;
        $cnt++;
