...
$d_name2 = array_unique($d_name);
$d_name2 = array_values(array_filter(array_map('trim',$d_name2)));
...
?>
    ...
    <head>
        ...
        <script src="js/common.js?v=2019042501"></script>
...
<?  if($_GET['flag']!='1'){ ?>
    ...
    <div class="hamburder_nav" style="z-index: 99;">
        ...
        <div class="hamnav_menu_wrap">
            ...
            <div class="hamnav_menu <?php if($res['type']=="채점강사") echo "dis";?>"><a href="class_schedule_write.php"><span>수업관리</span></a></div>
        ...
        <div class="alarm_box_wrap_wrap">
            <div class="alarm_box_wrap" style="display:none">
