                ...
                <div class="division col2">
                    ...
                    <div class="score_average">
                        ...
                        <div class="down_average">
                            <p class="lt">최고 점수</p>
                            <p class="rt"><span style="color: red;"><?=sprintf("%.1f", max($score_list))?></span><span>점</span></p>
                        </div>
                    </div>
                </div>
                <div class="division col2">
                    ...
                    <div class="score_average">
                        ...
                        <div class="down_average">
                            <p class="lt">동일학년</p>
                            <p class="rt"><span style="color: red;"><?=sprintf("%.1f", $a_tot/$a_cnt2/3)?></span><span>점</span></p>
                        </div>
                    </div>
                </div>
            </div>
